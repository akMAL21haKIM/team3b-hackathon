        ...
        <Grid columns={1}>
          <ExpansionPanel {...panel1Props} header="What does Amiibo do?">
            <Typography>
              ...
              includes a hidden radio frequency identification (RFID) chip. When
              a player scans the RFID chip inside an amiibo with a compatible
              Nintendo system, the system recognizes which amiibo it is and acts
              accordingly
            </Typography>
          </ExpansionPanel>
          ...
          >
            <Typography>
              ...
              optional and will simply add new elements to the gameplay
              (depending on the game).
            </Typography>
          </ExpansionPanel>

          <ExpansionPanel {...panel4Props} header="Are amiibos card worth it?">
            <Typography>
              ...
              then into your Village to live. It's a good way to control who you
              have living in your town.
            </Typography>
          </ExpansionPanel>
        </Grid>
      </div>
